...
import { Mail, Lock, ArrowRight, UserPlus, LogIn, ShieldAlert } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto py-12">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-[#FDFBF7] border border-[#D9C5A0]/30 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#427AB5]/20 focus:border-[#427AB5] transition-all text-sm"
              />
            </div>
            {email.endsWith('@admin.com') && (
              ...
              >
                <ShieldAlert size={12} /> Admin privileges will be granted
              </motion.p>
            )}
          </div>
          ...
          <button
            type="submit"
            className="w-full py-4 bg-[#427AB5] text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-[#406AAF] transition-all shadow-lg shadow-blue-500/20 active:scale-[0.98]"
          >
